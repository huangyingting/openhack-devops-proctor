...
(
    set -x
    az aks create -g $resourceGroupName -n $clusterName -l $resourceGroupLocation --node-count 3 --generate-ssh-keys -k 1.16.15 --service-principal $SP_ID --client-secret $SP_PASS
)
